...
namespace ToDoo.ViewModels
{
    public partial class MainViewModel:ViewModel
    {
        ...
        public MainViewModel(ITodoRepository repository, IServiceProvider services)
        {
        ...
        [RelayCommand]
        public async Task AddItemButton() => await Navigation.PushAsync(services.GetRequiredService<ItemView>());
        [RelayCommand]
        ...
        private void ItemStatusChanged(object sender, EventArgs e) 
        {
            if (sender is TodoItemViewModel item)
            {
                ...
                Task.Run(async () => await repository.UpdatedItemAsync(item.Item));
            }
        }
